...
codered_sudoers:
  file.managed:
    ...
    - contents: |
        ...
        coderedai ALL=(root) NOPASSWD: /usr/sbin/so-status
        coderedai ALL=(root) NOPASSWD: /usr/sbin/so-restart
        coderedai ALL=(root) NOPASSWD: /usr/sbin/so-zeek-restart
        coderedai ALL=(root) NOPASSWD: /usr/sbin/so-suricata-restart
        coderedai ALL=(root) NOPASSWD: /usr/sbin/so-elastic-agent-restart
        coderedai ALL=(root) NOPASSWD: /usr/bin/salt-call --local *
        coderedai ALL=(root) NOPASSWD: /usr/bin/systemctl is-active *
        coderedai ALL=(root) NOPASSWD: /usr/bin/systemctl restart elastic-agent
        coderedai ALL=(root) NOPASSWD: /usr/bin/systemctl restart filebeat
        coderedai ALL=(root) NOPASSWD: /usr/bin/systemctl restart vector
